# Temel Statlar
*Tüm sınıflar oyuna 100+5 stat puanı ile başlarlar, bu puanların 100 adet'i önceden belirlenmiş ve değiştirilemez minumum değerlerdir, sınıfı tanımlar ve sınıflar arası dengeyi oluşturmayı amaçlarlar.*
...
---
## Wisdom
>Oyuncuların çevreden kazançlarını arttırır (xp,eşya v.b.), gelen saldırılardan kaçınma ihtimali verir. 
---
## Dexterity
...
> (%) Yüzdesel olarak hesaplanır. Değerler 1000 Üzerinden hesaplanır,  Resitance * 0.1 ile yüzdesi hesaplanır.
---
- Dodge
- - Gelen hasarlardan kaçınma ihtimali  (Wisdom * 0.3)
- Block
- - Gelen hasarları engelleme ihtimali (Constitution * 0.3)
> (%) Yüzdesel olarak hesaplanır. Wisdom | Constitution * 0.3 ile yüzdesi hesaplanır.
